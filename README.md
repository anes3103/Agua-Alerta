...
**Sobre o Projeto**
 ...
 O Água Alerta é um projeto criado para ajudar as pessoas a registrar problemas relacionados à água e ao saneamento que fazem parte do dia a dia, como vazamentos, esgoto a céu aberto, água contaminada, falta de água e poluição de rios e córregos.Nossa ideia é desenvolver um sistema simples, onde qualquer pessoa possa registrar uma ocorrência, informar o local, explicar o que está acontecendo e, se quiser, adicionar imagens. A Inteligência Artificial também será utilizada para ajudar a analisar e organizar esses relatos, facilitando a identificação dos problemas e dando mais visibilidade às situações encontradas pela própria comunidade.
...
* Reduzir a poluição e melhorar a qualidade da água;
* Aumentar o tratamento e a reutilização segura de águas residuais;
...
O saneamento também está ligado à qualidade da água e à saúde pública, já que o descarte inadequado de resíduos contamina rios e outras fontes. Por isso, o projeto reforça a conscientização sobre descarte correto e gestão da água, alinhando-se aos objetivos da ODS 6.
 ...
 O Água Alerta apresenta uma forte conexão com a ODS 6 — Água Potável e Saneamento, principalmente com as metas ( 6.3, 6.6 e 6.b ).

 Por meio da tecnologia e da conscientização, o projeto busca contribuir para a redução do desperdício, a prevenção da poluição, a preservação dos recursos hídricos e a participação da comunidade.

 Dessa maneira, o Água Alerta contribui para uma visão de gestão da água baseada não apenas no consumo, mas também na **preservação, no uso sustentável, na informação e na participação da sociedade**.
